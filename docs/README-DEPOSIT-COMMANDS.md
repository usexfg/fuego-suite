...
2. **Term Understanding**: Understand the commitment period for regular deposits
...
### Fees
- **Regular Deposits**: Standard transaction fee
...
1. **"Deposit amount is too small"**
   ...
   - Remember amounts are in atomic units
