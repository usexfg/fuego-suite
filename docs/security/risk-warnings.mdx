...
Hearth is the on-chain **XFG/HEAT** market. Protocol trade fee is **1%** (`HEARTH_FEE_BPS = 100`), split **50% CD / 50% LP** in consensus code.
...
**Impermanent loss.** Inherent to AMM-style inventory. Large adverse moves can dominate fee income. Do not treat the old “0.3% LP fee” figure as Hearth’s protocol trade fee — that number is **not** `HEARTH_FEE_BPS`.
