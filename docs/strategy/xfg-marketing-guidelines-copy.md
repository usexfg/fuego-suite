...
- **Real yield, not inflationary rewards.** CD yields come from 80% of atomic swap fees. No token printing. No dilution of existing holders.
...
**Metrics:**
- CD yields paid from 80% of atomic swap fees (not token printing)
...
| Theme | Proof |
|-------|-------|
| Real yield, not token printing | 80% atomic swap fees → CD pool. Hearth fees → LPs. Verifiable on-chain. |
