...
**Full brand assets system (marks, lockups, HEAT/ΗΞΔŦ, inventory):** see [`brand-assets-guidelines.md`](./brand-assets-guidelines.md). DIGM is out of scope there.
...
**Color palette:** See `dashboard/static/css/style.css` — `--bg-primary: #0a0a0f`, `--accent: #ff6b35` (forge orange), `--green: #00d4aa` (positive/heat), `--red: #ff4757` (negative/sell). Mintlify docs: `#FF4500` / `#FF6B35` / `#CC3700` in `docs/docs.json`.
