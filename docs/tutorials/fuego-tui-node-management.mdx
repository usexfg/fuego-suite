  ...
  "step": [
    {
      ...
      "text": "Clone the source repository and run ./build.sh inside the tui directory to compile the dynamic terminal executable."
    },
    {
      "@type": "HowToStep",
      "name": "Launch Terminal Client",
      "text": "Execute ./fuego_suite for Mainnet or ./fuego_suite --testnet to load the tailored multi-network workspace."
    },
    {
      "@type": "HowToStep",
