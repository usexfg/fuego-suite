# Graph Report - xfgo  (2026-05-24)

## Corpus Check
- 1309 files · ~1,681,405 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13557 nodes · 22336 edges · 1316 communities (1210 shown, 106 thin omitted)
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 4385 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e8881093`
...
6. `get_block_hash()` - 60 edges
7. `ge_frombytes_vartime()` - 52 edges
8. `secp256k1_get_hash_context()` - 48 edges
9. `TEST()` - 48 edges
10. `throwIfStopped()` - 47 edges
...
## Communities (1316 total, 106 thin omitted)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (151): secp256k1_ellswift_xswiftec_frac_var(), secp256k1_ellswift_xswiftec_inv_var(), secp256k1_ellswift_xswiftec_var(), ellswift_encoding_test_vectors_tests(), secp256k1_ecdsa_sig_recover(), bench_ecmult_const_xonly_teardown(), bench_ecmult_multi_teardown(), bench_field_inverse() (+143 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (126): addWallet(), blocksAdded(), blocksRollback(), calculateDepositsAmount(), changePassword(), clearCacheAndShutdown(), clearCaches(), commitTransaction() (+118 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (86): BankingIndex(), reserve(), add_out_to_get_random_outs(), addNewBlock(), appendPath(), BlockCacheSerializer, BlockchainIndicesSerializer, blockDifficulty() (+78 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (110): checkFullyUnlocked(), checkHalfUnlocked(), request(), bench_ecdh(), bench_ecdh_setup(), memcmp_and_randomize(), secp256k1_wnaf_fixed(), secp256k1_ge_storage_cmov() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (86): ScopedTrace(), AddTestInfo(), Append(), ChopLowBits(), Clear(), ClearResult(), ClearTestPartResults(), CodePointToUtf8() (+78 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (47): add_new_tx(), addChain(), addObserver(), BlockWithTransactions, buildSparseChain(), check_tx_syntax(), core(), CryptoNote() (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (48): bind_internal(), bind_ip_address(), create_client_socket(), create_redirect_client(), create_server_socket(), dispatch_event(), duration_to_sec_and_usec(), get_ip_and_port() (+40 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (79): CalculateOptimalEdits(), CreateUnifiedDiff(), TestCase(), AddFailureHelper(), AddFatalFailure(), AddNonfatalFailure(), AnotherSubClassOfTest, AssertionResult (+71 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (67): beginsWith(), Common(), contains(), endsWith(), fill(), find(), findLast(), head() (+59 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (68): main(), main(), main(), fill_random(), print_hex(), secure_erase(), create_keypair(), main() (+60 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (48): check_block_rewards(), gen_block_reward(), generate(), get_tx_out_amount(), rewind_blocks(), test_chain_unit_base(), check_block_verification_context(), clearTransaction() (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (74): sign(), secp256k1_keypair_pub(), secp256k1_keypair_sec(), secp256k1_keyagg_cache_load(), secp256k1_keyagg_cache_save(), secp256k1_musig_keyaggcoef(), secp256k1_musig_keyaggcoef_internal(), secp256k1_musig_keyaggcoef_sha256() (+66 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (50): fillBlockDetails(), fillTransactionDetails(), fillTxExtra(), getMixin(), getPaymentId(), median(), computeBankingFeesFromTransactions(), CryptoNote() (+42 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (62): derivePublicKey(), derivePublicKeyCompressed(), Secp256k1Signer(), main(), secp256k1_extrakeys_ge_even_y(), secp256k1_keypair_create(), secp256k1_keypair_load(), secp256k1_keypair_save() (+54 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (11): fromHex(), on_get_random_outs(), on_get_transactions(), on_getblocktemplate(), on_send_raw_tx(), on_start_mining(), on_stop_mining(), on_submitblock() (+3 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (36): os(), append(), close_socket(), connect_with_proxy(), copy_settings(), create_and_connect_socket(), DataSink(), getline() (+28 more)
...
Cohesion: 0.08
Nodes (51): ecdsa_signature_parse_der_lax(), ec_privkey_export_der(), ec_privkey_import_der(), signRecoverable(), bench_recover(), secp256k1_ecdsa_recover(), secp256k1_ecdsa_recoverable_signature_convert(), secp256k1_ecdsa_recoverable_signature_load() (+43 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (40): AtomicSwapAnalyzer, CDConfig, CDFeePoolConfig, CDInterestCalculator, CryptographicPrimitives, FeeDistributionAnalyzer, FuegoBlockchainSpecialist, main() (+32 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (23): getMultisigOutputReference(), print_blockchain_outs(), add(), find(), GeneratedTransactionsIndex(), remove(), getObjectHash(), CryptoNote() (+15 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (42): TEST(), TestException, FooTest, ParamTest, TEST(), TEST_F(), AdHocTest(), ATypedDeathTest (+34 more)
...
Cohesion: 0.07
Nodes (50): Abort(), AssertHeld(), AtomMatchesChar(), AutoHandle(), BoolFromGTestEnv(), CapturedStream, CaptureStderr(), CaptureStdout() (+42 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (50): ecdh_hash_function_sha256(), ecdh_hash_function_sha256_impl(), secp256k1_ecdh(), test_bad_scalar(), test_ecdh_api(), test_ecdh_ctx_sha256(), test_ecdh_generator_basepoint(), test_ecdh_wycheproof() (+42 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (46): run_ecdh_bench(), run_ellswift_bench(), run_recovery_bench(), run_schnorrsig_bench(), bench_ecmult_0p_g(), bench_ecmult_0p_g_teardown(), bench_ecmult_1p(), bench_ecmult_1p_g() (+38 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (35): getPaymentIdFromTxExtra(), TEST_F(), WalletUserTransactionsCacheTest, on_get_transfers(), on_get_transfers(), addNewTransaction(), canInsertTransactionToIndex(), convertLegacyDeposits() (+27 more)
...
Cohesion: 0.05
Nodes (25): addObserver(), doGetNewBlocks(), doGetRandomCommitmentOutsForAmount(), doGetRandomOutsByAmounts(), doGetTransaction(), doGetTransactionOutsGlobalIndices(), doGetTransactions(), doGetTransactionsByPaymentId() (+17 more)
...
Cohesion: 0.05
Nodes (11): addBlock(), addChain(), addTransaction(), buildSparseChain(), findBlockchainSupplement(), getBlock(), getBlockHeight(), getPoolChanges() (+3 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (3): close_wallet(), complete_swap(), deinit()

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (27): insert(), allocate(), allocate_impl(), begin(), container_internal(), crbegin(), crend(), deallocate() (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (28): isEmpty(), CapacityToGrowth(), const_iterator(), construct(), constructor(), ConvertDeletedToEmptyAndFullToDeleted(), delete_element(), destroy() (+20 more)
...
Cohesion: 0.07
Nodes (32): binaryCommand(), doGetNewBlocks(), doGetPoolSymmetricDifference(), doGetRandomCommitmentOutsForAmount(), doGetRandomOutsByAmounts(), doGetTransaction(), doGetTransactionOutsGlobalIndices(), doQueryBlocksLite() (+24 more)

### Community 41 - "Community 41"
Cohesion: 0.1
Nodes (46): get_multipart_content_provider(), Post(), Put(), compress(), data(), decompress(), Delete(), divide() (+38 more)
...
Cohesion: 0.05
Nodes (44): 1. Install Dependencies, 1. Install Dependencies, 1. Prerequisites, 2. Build, 2. Build, 2. Clone and Build, 3. Start the Daemon, Advanced (+36 more)

### Community 44 - "Community 44"
Cohesion: 0.15
Nodes (40): adapt_signature(), adaptor_random_scalar(), complete_afk_signature(), extract_adaptor_secret(), extract_afk_secret(), generate_adaptor_signature(), generate_afk_lock_data(), check_dleq_proof() (+32 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (25): FuegoMapperMCPServer, main(), MCP Server implementation for Fuego Codebase Mapper, Main entry point for standalone execution, Set up MCP server handlers, CodebaseStats, FileInfo, main() (+17 more)
...
Cohesion: 0.07
Nodes (25): getBinaryArrayHash(), getInputAmount(), getInputsAmounts(), getOutputAmount(), addOutput(), derivePublicKey(), getExtraNonce(), getPaymentId() (+17 more)
...
Cohesion: 0.09
Nodes (34): asString(), check_split_not_switched(), check_split_not_switched2(), check_split_not_switched_back(), check_split_switched(), check_split_switched_back_1(), check_split_switched_back_2(), getBlocks() (+26 more)
...
Cohesion: 0.08
Nodes (32): LogToStderr(), Abort(), AddArguments(), Arguments, AssumeRole(), Create(), DeathTest(), DeathTestAbort() (+24 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (41): decomposeAmount(), isFusionTransaction(), addBurnDepositSecret(), addUnconfirmedTransaction(), calculateDonationAmount(), checkIfEnoughMixins(), convertOrdersToTransfers(), countNeededMoney() (+33 more)
...
Cohesion: 0.08
Nodes (32): checkParentBlockSize(), prevalidate_miner_transaction(), check_tx_inputs_keyimages_diff(), check_tx_mixin(), check_tx_semantic(), makeParentBlockSerializer(), check_inputs_overflow(), check_inputs_types_supported() (+24 more)
...
Cohesion: 0.07
Nodes (15): get_current_blockchain_height(), handle_notify_new_block(), handle_notify_new_lite_block(), handle_response_chain_entry(), handle_response_get_objects(), on_connection_synchronized(), onConnectionClosed(), process_payload_sync_data() (+7 more)

### Community 62 - "Community 62"
Cohesion: 0.11
Nodes (34): bench_ellswift_create(), bench_ellswift_decode(), bench_ellswift_encode(), bench_ellswift_setup(), bench_ellswift_xdh(), secp256k1_ellswift_create(), secp256k1_ellswift_decode(), secp256k1_ellswift_elligatorswift_var() (+26 more)
...
Cohesion: 0.08
Nodes (19): checkPaymentId(), createAddress(), createOutputBinaryFile(), createTemporaryFile(), createTrackingAddress(), createWalletFile(), deleteFile(), exportWallet() (+11 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (35): CaseInsensitiveCStringEquals(), ColoredPrintf(), CStringEquals(), current_test_result(), EndsWithCaseInsensitive(), FormatCountableNoun(), FormatTestCaseCount(), FormatTestCount() (+27 more)
...
Cohesion: 0.07
Nodes (19): actualBalance(), calculateActualBalance(), calculatePendingBalance(), ContextCounterHolder, deleteOutdatedUnconfirmedTransactions(), estimateFusion(), getActualBalanceChangedEvent(), getPendingBalanceChangedEvent() (+11 more)
...
Cohesion: 0.08
Nodes (20): addPortMapping(), append_net_address(), deinit(), handle_command_line(), handleConfig(), idle_worker(), init(), init_config() (+12 more)
...
Cohesion: 0.14
Nodes (32): addSubAddress(), checkDepositsAndCalculateAmount(), checkIfEnoughMixins(), constructTx(), countNeededMoney(), createChangeDestinations(), digitSplitStrategy(), doSendTransaction() (+24 more)
...
Cohesion: 0.07
Nodes (21): append_TransactionSourceEntry(), gen_uint_overflow_base(), generate(), split_miner_tx_outs(), test_chain_unit_base(), build(), fillInputs(), fillOutputs() (+13 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (23): AbslHashValue(), allocate(), begin(), deallocate(), delete_internal_node(), delete_leaf_node(), EmptyNode(), end() (+15 more)
...
Cohesion: 0.07
Nodes (19): generateRandomHash(), isEquivalent(), SetUp(), TEST_F(), WalletGetTransactionsStub, WalletServiceTest, WalletServiceTest_createAddress, WalletServiceTest_createDelayedTransaction (+11 more)
...
Cohesion: 0.1
Nodes (24): ~BaseFunctionalTests(), createNodeConfiguration(), getNodeTransactionPool(), launchInprocTestnet(), launchTestnet(), launchTestnetWithInprocNode(), makeWallet(), mineBlock() (+16 more)
...
Cohesion: 0.09
Nodes (32): append(), check_if_range(), create_and_connect_socket(), create_decompressor(), encode_uri_component(), encoding_type(), expect_content(), find_content_type() (+24 more)
...
Cohesion: 0.09
Nodes (17): classifyOutputAsset(), formatAmount(), generateGenesisBlock(), getTransactionOutputAssetAmounts(), init(), isBurnDeposit(), isValidBurnDepositAmount(), isValidBurnDepositTerm() (+9 more)
...
Cohesion: 0.09
Nodes (14): add_tx(), addTransactionInputs(), BlockTemplate, buildIndices(), fill_block_template(), get_difference(), haveSpentInputs(), init() (+6 more)
...
Cohesion: 0.16
Nodes (22): P2pContextOwner(), acceptLoop(), connectorLoop(), connectPeerList(), connectPeers(), createProxy(), doWithTimeoutAndThrow(), enqueueConnection() (+14 more)
...
Cohesion: 0.11
Nodes (20): CryptoNote(), CryptoNote(), Max(), PaymentService(), CDBook, fmt(), m1_raw(), m2_treasury_smoothed() (+12 more)
...
Cohesion: 0.23
Nodes (25): ge_p3_tobytes(), sc_reduce(), adaptorChallenge(), adaptSignature(), aliceInitialize(), asBytes(), bobInitialize(), computeFullSpendKey() (+17 more)
...
Cohesion: 0.08
Nodes (20): ArrayAsVector(), FormatWordList(), GetReservedAttributesForElement(), RecordProperty(), ValidateTestProperty(), ValidateTestPropertyName(), PropertyOne, TEST_F() (+12 more)

### Community 137 - "Community 137"
Cohesion: 0.18
Nodes (21): Join(), binPath(), burn2MintMenu(), createWalletCmd(), getBalanceCmd(), getInfo(), initialModel(), initVersionInfo() (+13 more)
...
Cohesion: 0.23
Nodes (23): buildSignedTx(), bytesToHex(), callContract(), claimHtlc(), deployContract(), deployHtlc(), EthRpcClient(), getBalance() (+15 more)
...
Cohesion: 0.12
Nodes (14): addFakeMultisignatureInput(), addInput(), addTestInput(), addTestMultisignatureInput(), appendExtra(), build(), buildReader(), buildTx() (+6 more)
...
Cohesion: 0.16
Nodes (19): JavaBridgeTest, add_device(), free_device(), main(), build_absolute_url(), FreeUPNPUrls(), GetUPNPUrls(), is_rfc1918addr() (+11 more)
...
Cohesion: 0.14
Nodes (17): testrand_init(), gettime_i64(), main(), help(), normalize_key(), parse_arg(), parse_iterations(), parse_seed() (+9 more)

### Community 155 - "Community 155"
Cohesion: 0.13
Nodes (20): cn_context(), size(), close(), close_socket(), connect_with_proxy(), enqueue(), handle_request(), initialize_ssl() (+12 more)
...
Cohesion: 0.14
Nodes (16): get_messages_from_extra(), addUnconfirmedTransaction(), checkOutputKey(), createTransfers(), findMyOutputs(), getBlockHashes(), getGlobalIndices(), getSyncStart() (+8 more)
...
Cohesion: 0.1
Nodes (10): CryptoNote(), P2pNode(), TEST(), Ipv4Address(), readUint8(), TEST(), TcpConnector(), TcpConnectorTests (+2 more)

### Community 164 - "Community 164"
Cohesion: 0.11
Nodes (14): CodeNode, ExpNode, ForNode, IfNode, LiteralDollarNode, ParseAtomicCodeNode(), ParseCodeNode(), ParseElseNode() (+6 more)

### Community 165 - "Community 165"
Cohesion: 0.16
Nodes (14): bchConnectedMsg, cursorBlinkMsg, ethConnectedMsg, HotkeyPair(), PairFromString(), refreshMsg, refreshTickMsg, statusUpdateMsg (+6 more)
...
Cohesion: 0.17
Nodes (14): formatTimestamp(), makeCenteredString(), deposit_amount(), deposit_height(), deposit_interest(), deposit_status(), deposit_term(), deposit_unlock_height() (+6 more)

### Community 176 - "Community 176"
Cohesion: 0.29
Nodes (21): createTransaction(), addAmmSwapAuthToExtra(), addLpAddAuthToExtra(), computePoolCommitKey(), convertSources(), convertTransaction(), countDepositsTotalSumAndInterestSum(), doSendAmmSwapV10CommitmentTransaction() (+13 more)
...
Cohesion: 0.14
Nodes (10): printIGD(), parseatt(), parseelt(), parsexml(), compare_igd(), compare_service(), main(), test_igd_desc_parse() (+2 more)
...
Cohesion: 0.15
Nodes (16): UPnP_addanyportmapping(), UPnP_addportmapping(), UPnP_connectiontype(), UPnP_deleteportmapping(), UPnP_deleteportmappingrange(), UPnP_externalipaddress(), UPnP_getgenericportmapping(), UPnP_getportmappingnumberofentries() (+8 more)
...
Cohesion: 0.15
Nodes (19): AddTestPartResult(), AppendUserMessage(), FilterTests(), FormatCxxExceptionMessage(), FormatSehExceptionMessage(), GetBoolAssertionFailureMessage(), GetInstance(), GetString() (+11 more)
...
Cohesion: 0.29
Nodes (16): check_adaptor_signature(), ge_add(), ge_double_scalarmult_base_vartime(), ge_double_scalarmult_precomp_vartime(), ge_dsm_precomp(), ge_p1p1_to_p3(), ge_p3_to_cached(), slide() (+8 more)

### Community 213 - "Community 213"
Cohesion: 0.2
Nodes (14): sc_add(), sc_mulsub(), sc_reduce32(), combineSpendKeys(), aggregateKeyImages(), computePartialKeyImage(), deterministicScalar(), hashToEc() (+6 more)

### Community 214 - "Community 214"
Cohesion: 0.15
Nodes (8): AddTestPattern(), Begin(), CreateTestFactory(), End(), IsValidParamName(), ParameterizedTestCaseRegistry(), RegisterTests(), TestInfo()
...
Cohesion: 0.18
Nodes (18): getAmount(), ammSwapV10(), deposit(), getActualDepositBalanceChangedEvent(), getPendingDepositBalanceChangedEvent(), heatDepositV10(), lpAddV10(), mintHeatV10() (+10 more)
...
Cohesion: 0.15
Nodes (17): check_tx_fee(), parse_hash256(), get_inputs_money_amount(), get_outs_money_amount(), f_getMixin(), f_on_block_json(), f_on_transaction_json(), fill_block_header_response() (+9 more)
...
Cohesion: 0.12
Nodes (8): BcSTest, ConsumerStub, FunctorialBlockhainConsumerStub, FunctorialPoolConsumerStub, IBlockchainSynchronizerFunctorialObserver, IBlockchainSynchronizerTrivialObserver, INodeFunctorialStub, INodeNonTrivialRefreshStub

### Community 239 - "Community 239"
Cohesion: 0.13
Nodes (5): base64Decode(), ipAddressToString(), is_base64(), std(), CryptoNote()

### Community 240 - "Community 240"
Cohesion: 0.23
Nodes (11): calc_poisson_ln(), Log(), serviceHandler(), changeDirectory(), init(), run(), runInProcess(), runRpcProxy() (+3 more)

### Community 241 - "Community 241"
Cohesion: 0.19
Nodes (12): run_ctz_tests(), run_secp256k1_byteorder_tests(), secp256k1_ctz32_var(), secp256k1_ctz32_var_debruijn(), secp256k1_ctz64_var(), secp256k1_ctz64_var_debruijn(), secp256k1_memzero_explicit(), secp256k1_read_be32() (+4 more)
...
Cohesion: 0.22
Nodes (13): AsyncConsoleReader(), ~ConsoleHandler(), consoleThread(), getline(), handleCommand(), handlerThread(), requestStop(), runCommand() (+5 more)
...
Cohesion: 0.18
Nodes (13): check_host_name(), verify_host(), verify_host_with_common_name(), verify_host_with_subject_alt_name(), coalesce_ranges(), if(), range_error(), verify_host() (+5 more)
...
Cohesion: 0.29
Nodes (14): CheckPinhole(), GetPinholeAndUpdate(), GetPinholeOutboundTimeout(), GetPinholePackets(), is_int(), ListRedirections(), main(), NewListRedirections() (+6 more)
...
Cohesion: 0.14
Nodes (12): buildHTLCLockCalldata(), ethBridgeHTML(), 2. Fee Split Restructuring, Code Changes, code:block1 (swap_fees → 80% CD pool), code:block2 (swap_fees → 80% CD pool → YEM (distributes to 3 CD types)), code:cpp (constexpr uint64_t SWAP_FEE_CD_SHARE_PCT        = 80;   // u), code:cpp (// constexpr uint64_t CD_YIELD_TREASURY_ROUTE_PCT = 40;  // ) (+4 more)
...
Cohesion: 0.15
Nodes (10): getAccountAddressAsStr(), getPenalizedAmount(), parseAccountAddressString(), accountAddressAsString(), blockGrantedFullRewardZoneByBlockVersion(), constructMinerTx(), generateGenesisTransaction(), getBlockReward() (+2 more)
...
Cohesion: 0.19
Nodes (13): actualHeatBalance(), calculateActualHeatBalance(), calculateHeatAmount(), calculatePendingHeatBalance(), getActualHeatBalanceChangedEvent(), getPendingHeatBalanceChangedEvent(), getPendingInvestmentBalanceChangedEvent(), notifyIfDepositBalanceChanged() (+5 more)
...
Cohesion: 0.32
Nodes (13): noexcept(), begin(), end(), g(), GetNumProbes(), insert(), iterator(), iterator_at() (+5 more)
...
Cohesion: 0.15
Nodes (12): Clarification: On-Fuego-Chain Aliases for Elderfiers, code:block1 (Elderfier address: XFG1a2b3c4d5e6f...), code:cpp (std::set<std::string> RESERVED_ALIASES = {), code:cpp (// In CommitmentIndex.h), Fuego Chain Alias System (On-Blockchain), Parallel with Dynamigo, Part 10: Total Effort, Part 12: Comparison: On-Fuego vs. L1/L2 (+4 more)
...
Cohesion: 0.18
Nodes (12): LevinProtocol(), add_host_fail(), ban_host(), block_host(), get_local_node_data(), handle_handshake(), handshake(), is_remote_host_allowed() (+4 more)
...
Cohesion: 0.18
Nodes (4): CryptoNote(), empty(), Clear(), next()

### Community 328 - "Community 328"
Cohesion: 0.17
Nodes (11): Backward Compatibility, Blockchain Integration, Conclusion, Gradual Rollout, Integration Points, Interest Payment System, Key Features, Migration Strategy (+3 more)
...
Cohesion: 0.21
Nodes (9): addCallback(), addCheckAccepted(), addCheckPurged(), TestGenerator(), distribution(), generator(), randomBytes(), Randomize() (+1 more)
...
Cohesion: 0.22
Nodes (7): poolGetEffectivePrice(), poolGetOutputAmount(), poolGetSpotPrice(), poolGetWithdrawalAmounts(), poolHasSufficientLiquidity(), poolMintLPShares(), executeSwap()
...
Cohesion: 0.24
Nodes (11): detail(), is_readable(), detail(), duration(), is_readable(), is_socket_alive(), is_ssl_peer_could_be_closed(), select_read() (+3 more)

### Community 344 - "Community 344"
Cohesion: 0.2
Nodes (8): CryptoNoteConnectionContext(), drop_connection(), IP2pEndpoint(), popBuffer(), safeInterrupt(), timeoutLoop(), writeDuration(), writeHandler()
...
Cohesion: 0.22
Nodes (11): getDelayedTransactionHashes(), getDeposit(), getDepositWithStagedInfo(), getTransaction(), init(), loadTransactionIdIndex(), loadWallet(), refresh() (+3 more)
...
Cohesion: 0.2
Nodes (8): CryptoNote(), invokeJsonRpcCommand(), JsonRpcError(), isCoreReady(), processJsonRpcRequest(), processRequest(), processRequest(), processRequest()

### Community 376 - "Community 376"
Cohesion: 0.27
Nodes (9): div128_32(), div_with_reminder(), hi_dword(), lo_dword(), mul128(), calculateInterest(), calculateTotalTransactionInterest(), nextDifficultyV2() (+1 more)

### Community 378 - "Community 378"
Cohesion: 0.24
Nodes (10): externalRelayNotifyToAll(), externalRelayNotifyToList(), forEachConnection(), interrupt(), invoke_notify_to_peer(), pushMessage(), relay_notify_to_all(), run() (+2 more)
...
Cohesion: 0.22
Nodes (10): connectionStatusUpdated(), interpret_rpc_response(), list_aliases(), lookup_alias(), printConnectionError(), register_alias(), release_alias(), start_mining() (+2 more)
...
Cohesion: 0.2
Nodes (3): AutoHandle(), FlushInfoLog(), OnThreadLocalDestroyed()
...
Cohesion: 0.2
Nodes (9): code:bash (cmake --build /home/ar/fuego/build -j$(nproc) 2>&1 | tail -2), code:cpp (// CD Fee Pool — funded by atomic swap (HTLC) fees, distribu), code:bash (git add src/CryptoNoteConfig.h), File Map, Modified Files, New Files, Task 1.5: Propagate New Type Through All Variant Visitors, Task 2: Add Fee Pool Constants (+1 more)
...
Cohesion: 0.31
Nodes (7): checkProofOfWork(), checkProofOfWorkV1(), cadc(), cadd(), check_hash(), mul(), main()
...
Cohesion: 0.28
Nodes (9): load_certs(), add_certs_to_x509_store(), Get(), is_running(), load_certs(), load_system_certs_on_macos(), load_system_certs_on_windows(), retrieve_certs_from_keychain() (+1 more)
...
Cohesion: 0.28
Nodes (7): chacha8(), decrypt(), importLegacyKeys(), loadKeysFromFile(), verify_keys(), loadAndDecryptContainerData(), loadWalletCache()
...
Cohesion: 0.33
Nodes (6): asBinaryArray(), Common(), doPushLiteBlock(), handle_notify_new_transactions(), doQueryBlocksLite(), queryBlocksLiteAsync()
...
Cohesion: 0.38
Nodes (3): evtlistcmp(), main(), testxmlparser()
...
Cohesion: 0.33
Nodes (6): blockMajorVersionAtHeight(), getTransactionAllInputsAmount(), getTransactionFee(), getTransactionInputAmount(), minimumFee(), upgradeHeight()
...
Cohesion: 0.47
Nodes (5): testing(), FormatFileLocation(), SkipSpaces(), SplitIntoTestNames(), VerifyRegisteredTestNames()
...
Cohesion: 0.4
Nodes (5): addAmmSwapToExtra(), hearth_buy(), hearth_sell(), mint_heat(), swap()
...
Cohesion: 0.4
Nodes (3): PaymentGateTest, TEST_F(), createWalletService()
...
Cohesion: 0.4
Nodes (3): Config, DefaultConfig(), main()
...
Cohesion: 0.5
Nodes (4): askAliasesTransfersConfirmation(), processServerAliasResponse(), resolveAlias(), transfer()

### Community 642 - "Community 642"
Cohesion: 0.5
Nodes (4): convertTransactionsInBlockInfoToTransactionsInBlockRpcInfo(), convertTransactionWithTransfersToTransactionRpcInfo(), getPaymentIdFromExtra(), getPaymentIdStringFromExtra()
...
Cohesion: 0.5
Nodes (4): fetchPeerList(), fixTimeDelta(), getNodeData(), handleRemotePeerList()
...
Cohesion: 0.67
Nodes (3): listTransfers(), printListTransfersHeader(), printListTransfersItem()
...
## Knowledge Gaps
- **2561 isolated node(s):** `Analyze Fuego source code for blockchain mechanics`, `Analyze CD interest calculation code`, `Analyze atomic swap implementation code`, `Analyze P2P networking code`, `Analyze cryptographic primitives` (+2556 more)
...
- **Why does `Assert()` connect `Community 9` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 22`, `Community 24`, `Community 539`, `Community 28`, `Community 29`, `Community 30`, `Community 34`, `Community 36`, `Community 37`, `Community 40`, `Community 41`, `Community 44`, `Community 50`, `Community 53`, `Community 55`, `Community 56`, `Community 61`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 587`, `Community 590`, `Community 78`, `Community 82`, `Community 83`, `Community 87`, `Community 88`, `Community 91`, `Community 93`, `Community 94`, `Community 95`, `Community 103`, `Community 105`, `Community 106`, `Community 107`, `Community 110`, `Community 138`, `Community 146`, `Community 155`, `Community 159`, `Community 163`, `Community 176`, `Community 177`, `Community 182`, `Community 199`, `Community 202`, `Community 211`, `Community 215`, `Community 216`, `Community 227`, `Community 229`, `Community 235`, `Community 245`, `Community 255`, `Community 258`, `Community 264`, `Community 272`, `Community 282`, `Community 293`, `Community 299`, `Community 825`, `Community 323`, `Community 325`, `Community 327`, `Community 330`, `Community 344`, `Community 352`, `Community 353`, `Community 376`, `Community 378`, `Community 387`, `Community 388`, `Community 389`, `Community 390`, `Community 410`, `Community 417`, `Community 418`, `Community 419`, `Community 451`, `Community 462`, `Community 507`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `generator()` connect `Community 330` to `Community 53`, `Community 214`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `RegisterTests()` connect `Community 214` to `Community 330`, `Community 5`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Are the 330 inferred relationships involving `Assert()` (e.g. with `startNode()` and `stopNode()`) actually correct?**
  _`Assert()` has 330 INFERRED edges - model-reasoned connections that need verification._
