...
public:
  ...
  virtual void getOutput(size_t index, TransactionOutputOrder& output, uint64_t& amount) const = 0;
...
public: 
  ...
  virtual size_t addOutput(uint64_t amount, const TransactionOutputOrder& out) = 0;
  // transaction info
