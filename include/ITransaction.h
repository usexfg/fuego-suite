...
namespace TransactionTypes {
  ...
  enum class OutputType : uint8_t { Invalid, Key, Multisignature, Commitment, Unified };
...
public:
  ...
  virtual void getOutput(size_t index, TransactionOutputUnified& output, uint64_t& amount) const = 0;
...
public: 
  ...
  virtual size_t addOutput(uint64_t amount, const TransactionOutputUnified& out) = 0;
  // transaction info
