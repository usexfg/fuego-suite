import { z } from "zod";
import { ARCHITECTURE_OVERVIEW, MODULE_CONTEXT, RPC_REFERENCE, DATA_TYPES, CRYPTO_EXPLAINER, TOKEN_MODEL, BUILD_GUIDE, } from "../context.js";
export function registerContextTools(server) {
    server.registerTool("fuego_get_overview", {
...
Returns comprehensive markdown documentation.`,
        ...
        content: [{ type: "text", text: ARCHITECTURE_OVERVIEW }],
    }));
    const moduleNames = Object.keys(MODULE_CONTEXT);
    server.registerTool("fuego_get_module_info", {
...
Examples:
  ...
  - Understand terminal UI: module="TUI"`,
        inputSchema: z.object({
            module: z.enum(moduleNames).describe(`Module name. One of: ${moduleNames.join(", ")}`),
        }).strict(),
        annotations: {
            readOnlyHint: true,
            destructiveHint: false,
    ...
    server.registerTool("fuego_get_rpc_reference", {
...
Use when implementing clients, debugging RPC calls, or understanding API capabilities.`,
        ...
        content: [{ type: "text", text: RPC_REFERENCE }],
    }));
    server.registerTool("fuego_get_data_types", {
...
or work with the C++ codebase.`,
        ...
        content: [{ type: "text", text: DATA_TYPES }],
    }));
    server.registerTool("fuego_get_crypto_explainer", {
...
how privacy is achieved.`,
        ...
        content: [{ type: "text", text: CRYPTO_EXPLAINER }],
    }));
    server.registerTool("fuego_get_token_model", {
...
Elderfier system (staking, governance, rewards), and swap fee distribution.`,
        ...
        content: [{ type: "text", text: TOKEN_MODEL }],
    }));
    server.registerTool("fuego_get_build_guide", {
