#!/usr/bin/env python3
"""Final Design v19 — 50/50 mint split, 100% atomic→CD, no YEM, no bonds."""
            ...
            for _ in range(40):
                ...
                if hp2>HEAT_PEG:
                    ...
                    if out_xfg>0 and out_xfg<px:
                        hs+=a;ph+=a;px-=out_xfg
                        # Mint: 50% of mint value → Eternal Flame (burned)
                        # Treasury gets: 50% share + pool XFG from selling HEAT
                        xfg_value=a*red
...
SEED=20260606
print(f"\n{'='*105}")
print(f"  v19 — 50/50 mint split | 100% atomic → CD | No YEM, no bonds, no scalp")
