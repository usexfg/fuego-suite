...
public:
  ...
  virtual bool supportsOutputsHeights() const override { return false; }  // DISABLED: applyOspeadFilter blocks via fut.get() deadlocking the dispatcher; rewrite as non-blocking before re-enabling.
