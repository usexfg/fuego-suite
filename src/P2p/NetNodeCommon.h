...
namespace CryptoNote {
  ...
  struct IP2pEndpoint {
    ...
    virtual void relay_notify_stem(int command, const BinaryArray& data_buff, const net_connection_id* excludeConnection) = 0;
    ...
    virtual void externalRelayNotifyToStem(int command, const BinaryArray &data_buff, const net_connection_id *excludeConnection) = 0;
