...
// DIGM colored coin subsystem disabled pending HEAT two-coin implementation
...
namespace CryptoNote
{
  ...
  private:
    ...
    // std::unique_ptr<CryptoNote::DIGMSimpleWalletExtension> m_digm_extension;  // DIGM disabled
