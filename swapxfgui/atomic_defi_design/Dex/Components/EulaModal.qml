...
MultipageModal
{
    ...
    function getEula()
    {
        return "<h2>This End-User License Agreement ('EULA') is a legal agreement between you and ЅШ𑫛𑫒❊XFG.</h2>
<p>This EULA agreement governs your acquisition and use of our %1 software ('Software', 'Mobile Application', 'Application' or 'App') directly from ЅШ𑫛𑫒❊XFG or indirectly through a ЅШ𑫛𑫒❊XFG authorized entity, reseller or distributor (a 'Distributor').</p>
...
<p>This EULA agreement shall apply only to the Software supplied by ЅШ𑫛𑫒❊XFG herewith regardless of whether other software is referred to or described herein. The terms also apply to any ЅШ𑫛𑫒❊XFG updates, supplements, Internet-based services, and support services for the Software, unless other terms accompany those items on delivery. If so, those terms apply.</p>
<h3>License Grant</h3>
<p>ЅШ𑫛𑫒❊XFG hereby grants you a personal, non-transferable, non-exclusive licence to use the %1 software on your devices in accordance with the terms of this EULA agreement.</p>
...
<li>Use the Software for any purpose that ЅШ𑫛𑫒❊XFG considers is a breach of this EULA agreement</li>
</ul>
<h3>Intellectual Property and Ownership</h3>
<p>ЅШ𑫛𑫒❊XFG shall at all times retain ownership of the Software as originally downloaded by you and all subsequent downloads of the Software by you. The Software (and the copyright, and other intellectual property rights of whatever nature in the Software, including any modifications made thereto) are and shall remain the property of ЅШ𑫛𑫒❊XFG.</p>
<p>ЅШ𑫛𑫒❊XFG reserves the right to grant licences to use the Software to third parties.</p>
<h3>Termination</h3>
<p>This EULA agreement is effective from the date you first use the Software and shall continue until terminated. You may terminate it at any time upon written notice to ЅШ𑫛𑫒❊XFG.</p>
