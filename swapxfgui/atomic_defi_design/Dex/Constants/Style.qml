...
QtObject {
    ...
    readonly property FontLoader fontSpaceGrotesk: FontLoader { source: "../../assets/fonts/SpaceGrotesk-Variable.ttf" }
    readonly property FontLoader fontChakraPetch: FontLoader { source: "../../assets/fonts/ChakraPetch-Bold.ttf" }
    readonly property FontLoader fontJetBrainsMono: FontLoader { source: "../../assets/fonts/JetBrainsMono-Regular.ttf" }
    readonly property string font_family: "Space Grotesk"
