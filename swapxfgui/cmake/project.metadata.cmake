...
set(DEX_PROJECT_NAME "swapxfg")
set(DEX_DISPLAY_NAME "ЅШ𑫛𑫒❊XFG")
set(DEX_MAINTENANCE_TOOL_NAME "ЅШ𑫛𑫒❊XFG Maintenance Tool")
set(DEX_COMPANY "UseXFG")
set(DEX_VERSION "0.7.0")
set(DEX_WEBSITE "https://usexfg.org")
set(DEX_SUPPORT_PAGE "https://docs.usexfg.org")
set(DEX_DISCORD "https://discord.com/invite/TGZPRbRT3Y")
set(DEX_TWITTER "https://twitter.com/usexfg")
set(DEX_PRIMARY_COIN "XFG")                                                         ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
set(DEX_SECOND_PRIMARY_COIN "HEAT")                                                  ## Second main coin of the DEX, will be enabled by default and will be the default right ticker for trading
set(DEX_REPOSITORY_OWNER ${DEX_COMPANY})
set(DEX_REPOSITORY_NAME "fuegoDEX")
set(DEX_CHECKSUM_API_URL "https://usexfg.org/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "swapxfg")
else ()
    set(DEX_APPDATA_FOLDER "swapxfg")
endif ()
...
macro(generate_macos_metafiles)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.usexfg.swapxfg/meta/package.xml.in
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.usexfg.swapxfg/meta/package.xml)
    configure_file(${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.usexfg.swapxfg/meta/installscript.qs.in
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.usexfg.swapxfg/meta/installscript.qs)
...
macro(generate_windows_metafiles)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/meta/package.xml.in
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/meta/package.xml)
    configure_file(${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/meta/installscript.qs.in
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/meta/installscript.qs)
    configure_file(${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/dex.exe.manifest.in
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/data/${DEX_PROJECT_NAME}.exe.manifest)
    configure_file(${CMAKE_CURRENT_LIST_DIR}/assets/logo/dex-logo.ico
            ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/windows/packages/com.usexfg.swapxfg/data/${DEX_PROJECT_NAME}.ico
            COPYONLY)
